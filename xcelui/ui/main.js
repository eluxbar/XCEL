    ...
    var e = {
            ...
            622: (e, t, n) => {
                ...
                function br(e, t, n) {
                    ...
                    yr || null == vr || vr !== Q(r) || (r = "selectionStart" in (r = vr) && xcel(r) ? {
                ...
                function Ml(e, t) {
                    ...
                    if (null !== Qs && 0 == (24 & r) && Qs.has(e) && Qs.delete(e), e === Ms && (Ps = Ms = null, Os = 0), 1 < n.flags ? null !== n.lastEffect ? (n.lastEffect.nextEffect = n, r = n.firstEffect) : r = n : r = n.firstEffect, null !== r) {
                        if (a = Ts, Ts |= 32, ks.current = null, Dr = qt, xcel(s = pr())) {
            ...
            118: (e, t, n) => {
                ...
                n.r(t), n.d(t, {
                    ...
                    if (t >= 0) {
                        ...
                        n.items ? e.showNestedMenu(n) : e.onClick && (e.onClick(n), e.closeOnClick && (e.close(), fetch("http://XCEL/disablenuifocus", {
                            method: "POST",
                            body: JSON.stringify({
                                nuifocus: !1
                            })
                    ...
                    var e = this;
                    e.parentItems.length > 0 ? e.returnToParentMenu() : (e.close(), fetch("http://XCEL/disablenuifocus", {
                        method: "POST",
                        body: JSON.stringify({
                            nuifocus: !1
                        })
            ...
            22: (e, t, n) => {
                ...
                class o extends a.Component {
                    ...
                    countdownEnded() {
                        fetch("https://xcelui/countdownEnded", {
                            method: "POST",
                            body: ""
                    ...
                    render() {
                        return s.jsx(s.Fragment, {
                            children: s.jsx("div", Object.assign({
                                className: "xcel-spawn"
                            }, {
                                children: s.jsxs("div", Object.assign({
                                    className: "xcel-locations"
                                }, {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    switch (n.type) {
                        ...
                        case "RESPAWN_BUTTON_CLICK":
                            return fetch("https://xcelui/respawnButtonClicked", {
                                method: "POST",
                                body: JSON.stringify({
