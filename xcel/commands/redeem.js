...
exports.runcmd = (fivemexports, client, message, params) => {
    ...
    fivemexports.xcel.execute("SELECT * FROM `xcel_stores` WHERE code = ?", [code], (infoArray) => {
        ...
        fivemexports.xcel.execute("SELECT discord_id FROM `xcel_verification` WHERE user_id = ?", [user_id], (discordIdArray) => {
            ...
            message.channel.send({ embed }).then(sentEmbed => {
                ...
                collector.on('collect', reaction => {
                    ...
                    if (reaction.emoji.name === "✅") {
                        // User confirmed
                        fivemexports.xcel.execute("DELETE FROM xcel_stores WHERE code = ?", [code], (result) => {
