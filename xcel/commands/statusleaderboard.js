...
exports.runcmd = (fivemexports, client, message, params) => {
    ...
    if (!foundUser) {
        // If the user is not found in the leaderboard, show a message indicating they haven't added "discord.gg/xcel5m" in their status.
        message.channel.send("You have not added `discord.gg/xcel5m` to your status.");
    }
}
