...
exports.runcmd = (fivemexports, client, message, params) => {
    ...
    let totalBank = 0;
    let totalChips = 0;
    fivemexports.xcel.execute("SELECT * FROM `xcel_user_vehicles`", [], (cars) => {
        fivemexports.xcel.execute("SELECT * FROM `xcel_user_vehicles` WHERE locked = 1", [], (lockedcars) => {
            fivemexports.xcel.execute("SELECT * FROM `xcel_user_data`", [], (userdata) => {
                fivemexports.xcel.execute("SELECT * FROM xcel_warnings", [], (warnings) => {
                    fivemexports.xcel.execute("SELECT * FROM xcel_user_moneys", [], (money) => {
                        fivemexports.xcel.execute("SELECT * FROM xcel_casino_chips", [], (chips) => {
                            fivemexports.xcel.execute("SELECT * FROM `xcel_users`", [], (users) => {
                                fivemexports.xcel.execute("SELECT * FROM xcel_users WHERE banned = 1", (bannedPlayers) => {
                                    fivemexports.xcel.execute("SELECT * FROM xcel_anticheat", (totalACBans) => {
                                        fivemexports.xcel.execute("SELECT MAX(id) as maxId FROM `xcel_users`", [], (totalperms) => {
