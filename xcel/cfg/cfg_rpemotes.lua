...
RP.Shared = {
    ...
    ["carryfr"] = { -- Male Custom emote by XCEL Mods
        "couplepose1fr@animation",
        "couplepose1xcel_clip",
        "Carry Me Cute 3",
        "carryfr2",
        AnimationOptions = {
            EmoteMoving = false,
    ...
    ["carryfr2"] = { -- Female Custom emote by XCEL Mods
        "couplepose2fr@animation",
        "couplepose2xcel_clip",
        "Carry Me Cute 4",
        "carryfr",
        AnimationOptions = {
            EmoteLoop = true,
...
RP.PropEmotes = {
    ...
    ["skatesit"] = { -- Custom Emote By XCEL Mods
        "skateboardposefranimation",
        "skateboardposexcel_clip",
        "Skateboard - Sit",
        AnimationOptions = {
