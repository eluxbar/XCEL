...
cfg.items = {
    ...
    ["melee_import"] = {
        name = "Melee Import",
        description = "To use this item open a Weapon Ticket in the XCEL Support Tickets Discord.",
        manuallyRedeemable = false,
        canTransfer = true
    },
    ["pistol_import"] = {
    ...
    ["xcel_plus"] = {
        name = "XCEL Plus (30 Days)",
        manuallyRedeemable = true,
        canTransfer = true
    },
    ["xcel_platinum"] = {
        name = "XCEL Platinum (30 Days)",
        manuallyRedeemable = true,
        canTransfer = true
    },
    ["supporter"] = {
    ...
    ["lock_slot"] = {
        name = "Lock Slot",
        description = "To use this item open a Ticket in the XCEL Support Tickets Discord.",
        manuallyRedeemable = false,
        canTransfer = true
    },
    ["import_slot"] = {
        name = "Import Slot",
        description = "To use this item as an import slot open a Ticket in the XCEL Support tickets Discord.",
        manuallyRedeemable = true,
        canTransfer = true,
        args = "import_slot"
    },
...
local customCars = {
    ["Compacts"] = {
        ...
        ["a45amg"] = "Mercedes Axcel A45 Edition One",
