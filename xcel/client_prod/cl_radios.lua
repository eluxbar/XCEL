...
local b = {}
local c = 0
function tXCEL.isInRadioChannel()
    return c ~= 0
end
local function d()
...
RMenu.Add(
    "radios",
    "mainmenu",
    RageUI.CreateMenu("Radios", "Main Menu", tXCEL.getRageUIMenuWidth(), tXCEL.getRageUIMenuHeight())
)
RMenu.Add(
    "radios",
    "advancedeffects",
...
RegisterCommand(
    ...
    function()
        ...
        TriggerEvent("XCEL:showRadioWheel", X)
    end,
    false
)
...
RegisterCommand(
    ...
    function()
        if c ~= 0 then
            if exports["pma-voice"]:getRadioVolume() == 0 then
                exports["pma-voice"]:setRadioVolume(u("radios_volume", 10) * 10)
                TriggerServerEvent("XCEL:radiosSetIsMuted", false)
            else
                exports["pma-voice"]:setRadioVolume(0)
                TriggerServerEvent("XCEL:radiosSetIsMuted", true)
            end
        end
    end,
    false
...
AddEventHandler(
    "XCEL:openRadioConfig",
    function()
        RageUI.Visible(RMenu:Get("radios", "mainmenu"), true)
    end
)
function tXCEL.radioUIVisible(Y)
    e(Y)
end
