local a = {
    ...
    [74] = {
        id = 74,
        position = vector3(-2171.8093261719,5141.5703125,2.819997549057),
        name = "VIP Island",
        destination = {75, 76},
    },
    [75] = {
    ...
    [77] = {
        id = 77,
        position = vector3(3070.5285644531,-4716.267578125,15.262372016907),
        name = "Admin Island",
        destination = {75,76},
    },
    [95] = {
...
RMenu.Add(
    "vkint",
    "mainmenu",
    RageUI.CreateMenu("Teleporter", "Main Menu", tXCEL.getRageUIMenuWidth(), tXCEL.getRageUIMenuHeight())
)
local b = nil
local function c(d)
    if tXCEL.getPlayerCombatTimer() > 0 then
        tXCEL.notify("~r~You can not teleport whilst you have a combat timer.")
        return
    end
...
Citizen.CreateThread(
    function()
        for f, d in pairs(a) do
            tXCEL.addMarker(d.position.x, d.position.y, d.position.z - 1, 1.0, 1.0, 1.0, 255, 255, 255, 170, 50, 27)
            tXCEL.createArea(
                "vkint_" .. d.id,
                d.position,
                2.0,
