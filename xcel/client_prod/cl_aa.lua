RMenu.Add(
    "AAMenu",
    "main",
    RageUI.CreateMenu("", "~y~AA ~w~Menu", tXCEL.getRageUIMenuWidth(), tXCEL.getRageUIMenuHeight(), "xcel_aaui", "xcel_aaui")
)
RageUI.CreateWhile(
    1.0,
    true,
...
RegisterCommand(
    "aamenu",
    function()
        TriggerServerEvent("XCEL:openAAMenu")
    end
)
tXCEL.addBlip(495.36367797852, -1329.1535644531, 29.339862823486, 446, 5, "AA Mechanic")
function tXCEL.openAAMenu()
