...
RMenu:Get("XCELChips", "cashier"):SetSubtitle("CHIPS")
RMenu.Add(
    "casino_enter",
    "casino",
    RageUI.CreateMenu(
...
RageUI.CreateWhile(
    ...
    true,
    function()
        if RageUI.Visible(RMenu:Get("XCELChips", "cashier")) then
            RageUI.DrawContent(
                ...
                function()
                        ...
                        function(l, m, n)
                            if n then
                                ...
                                if tonumber(o) then
                                    o = tonumber(o)
                                    if o > 0 then
                                        TriggerServerEvent("XCEL:buyChips", o)
                                    else
                                        tXCEL.notify("Negative amount.")
                                    end
                                else
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(l, m, n)
                            if n then
                                TriggerServerEvent("XCEL:buyChips")
                            end
                        end
                    )
                    RageUI.ButtonWithStyle(
                        ...
                        function(l, m, n)
                            if n then
                                ...
                                if tonumber(o) then
                                    o = tonumber(o)
                                    if o > 0 then
                                        TriggerServerEvent("XCEL:sellChips", o)
                                    else
                                        tXCEL.notify("Negative amount.")
                                    end
                                else
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(l, m, n)
                            if n then
                                TriggerServerEvent("XCEL:sellChips")
                            end
                        end
                    )
                end
            ...
            RageUI.DrawContent(
                ...
                function()
                    RageUI.ButtonWithStyle(
                        ...
                        function(l, m, n)
                            if n then
                                TriggerServerEvent("XCEL:exitDiamondCasino")
                                tXCEL.teleport(e.x, e.y, e.z)
                                if cardObjects then
            ...
            RageUI.DrawContent(
                ...
                function()
                    RageUI.ButtonWithStyle(
                        ...
                        true,
                        function(l, m, n)
                            if n and tXCEL.getPlayerCombatTimer() == 0 then
                                TriggerServerEvent("XCEL:enterDiamondCasino")
                                tXCEL.teleport(f.x, f.y, f.z)
                            end
                        end
                    )
                    RageUI.ButtonWithStyle(
...
function showCasinoChipsCashier(s)
    ...
    RageUI.Visible(RMenu:Get("XCELChips", "cashier"), s)
end
...
Citizen.CreateThread(
    function()
        while true do
            local t = GetEntityCoords(tXCEL.getPlayerPed())
            a = #(t - e)
            b = #(t - f)
            c = #(t - g)
            Wait(100)
...
RegisterNetEvent("XCEL:setDisplayChips")
AddEventHandler(
    "XCEL:setDisplayChips",
    function(v)
    ...
    function(x, y)
        if y then
            ...
            for C, k in pairs(h) do
                tXCEL.addBlip(k.entryPosition.x, k.entryPosition.y, k.entryPosition.z, 683, 0, "Chips Cashier", 0.7, true)
                tXCEL.addMarker(
                    k.entryPosition.x,
                    k.entryPosition.y,
                    k.entryPosition.z,
                ...
                tXCEL.createArea("chipscashier_" .. C, k.entryPosition, 1.5, 6, z, y, A, {})
            end
