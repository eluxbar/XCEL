...
-- RMenu.Add("XCELHousing", "main", RageUI.CreateMenu("", "", tXCEL.getRageUIMenuWidth(), tXCEL.getRageUIMenuHeight(), "banners", "homes"))
-- RMenu.Add("XCELHousing", "leave", RageUI.CreateMenu("", "", tXCEL.getRageUIMenuWidth(), tXCEL.getRageUIMenuHeight(), "banners", "homes"))

-- RageUI.CreateWhile(1.0, true, function()
--     if RageUI.Visible(RMenu:Get("XCELHousing", "main")) then
...
--         RMenu:Get("XCELHousing", "main"):SetSubtitle("" .. e)
--         RageUI.Visible(RMenu:Get("XCELHousing", "main"), true)
--     end
--     local function H(data)
--         RageUI.CloseAll()
--         RageUI.Visible(RMenu:Get("XCELHousing", "main"), false)
--     end
--     local function I(data) end
--     for k, v in pairs(cfghomes.homes) do
--         tXCEL.createArea("house_" .. k, v.entry_point, 1.5, 6, F, H, I, {currentHouse = k, currentHousePrice = v.buy_price})
--         tXCEL.addMarker(v.entry_point.x, v.entry_point.y, v.entry_point.z, 0.7, 0.7, 0.5, 0, 255, 125, 125, 50, 20, false, false, true)
--     end
--     while true do
--         Citizen.Wait(0)
--         for l, m in pairs(cfghomes.homes) do
--             if XCEL.isInHouse() and e == l then
...
--                         TriggerServerEvent('XCEL:FetchHouseInventory', e)
--                     end
--                 end
...
--                     TriggerEvent('XCEL:closeOutfitMenu')
--                     d = false
--                 end
...
--                     e = l
--                     RMenu:Get("XCELHousing", "leave"):SetSubtitle("" .. e)
--                     RageUI.Visible(RMenu:Get("XCELHousing", "leave"), true)
--                     c = true
--                 end
--                 if c and e == l and #(coords - m.leave_point) > 0.8 then
--                     RageUI.Visible(RMenu:Get("XCELHousing", "leave"), false)
--                     c = false
--                 end
--             end
--         end
