...
RMenu.Add(
    "store",
    "mainmenu",
    RageUI.CreateMenu("", "Inventory", tXCEL.getRageUIMenuWidth(), tXCEL.getRageUIMenuHeight(), "xcel_storeui", "xcel_storeui")
)
RMenu.Add(
    "store",
    "info",
...
RMenu.Add(
    "store",
    "redeem",
    RageUI.CreateSubMenu(RMenu:Get("store", "info"), "", "Redeem", tXCEL.getRageUIMenuWidth(), tXCEL.getRageUIMenuHeight())
)
RMenu.Add(
    "store",
    "vehicleList",
...
local function a2(K)
    l = true
    TriggerServerEvent("XCEL:setInVehicleTestingBucket", true)
    z = tXCEL.getPlayerCoords()
    w = 1
    ...
    m = tXCEL.spawnVehicle(K, a4.x, a4.y, a4.z, a5, true, false, false)
    n = GetGameTimer()
end
                ...
                function()
                    ...
                    if next(b) then
                        ...
                        RageUI.ButtonWithStyle(
                            ...
                            function(m, q, r)
                                if r then
                                    tXCEL.OpenUrl("https://store.xcelstudios.com/")
                                end
                            end
                        )
                    end
                ...
                function()
                    ...
                    if U.manuallyRedeemable then
                        RageUI.ButtonWithStyle(
                            ...
                            function(X, Y, Z)
                                if Z then
                                    TriggerServerEvent("XCEL:getStoreLockedVehicleCategories")
                                end
                            end,
                            RMenu:Get("store", "redeem")
                        )
                            ...
                            function(X, Y, Z)
                                if Z then
                                    if isInGreenzone then
                                        TriggerServerEvent("XCEL:startSellStoreItem", d)
                                    else
                ...
                function()
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(X, Y, Z)
                            if Z then
                                if T(U) then
                                    TriggerServerEvent("XCEL:redeemStoreItem", d, e)
                                else
                ...
                function()
                    for ag, F in ae(f.items, false) do
                        if type(F) == "table" then
                            ...
                            local aj = J(ag)
                            local ai = aj and "" or "~r~You can not own more than one of this vehicle."
                            RageUI.Button(
                                F,
                                ai,
                                aj and {RightLabel = "→→→"} or {RightLabel = ""},
                ...
                function()
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(X, Y, Z)
                            if Z then
                                if
                                    tXCEL.canAnim() and tXCEL.getPlayerCombatTimer() == 0 and tXCEL.getPlayerVehicle() == 0 and
                                        not tXCEL.isPlayerInRedZone() and
                                        tXCEL.getPlayerBucket() == 0
                                 then
                                    a2(g)
                                else
...
RMenu.Add(
    "vehicletesting",
    "mainmenu",
    RageUI.CreateMenu("", "Main Menu", tXCEL.getRageUIMenuWidth(), tXCEL.getRageUIMenuHeight(), "xcel_storeui", "xcel_storeui")
)
RMenu.Add(
    "vehicletesting",
    "extras",
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(X, Y, Z)
                            if Z then
                                ...
                                TriggerServerEvent("XCEL:setInVehicleTestingBucket", false)
...
local function az()
    if l then
        ...
        local vehicle, aA = tXCEL.getPlayerVehicle()
...
function tXCEL.isInStoreTesting()
    return l
end
RegisterNetEvent(
    "XCEL:storeDrawEffects",
    function()
        tXCEL.loadPtfx("scr_xs_celebration")
        tXCEL.loadPtfx("scr_rcpaparazzo1")
        for I = 1, 4 do
...
RegisterNetEvent(
    "XCEL:setStoreLockedVehicleCategories",
    function(aB)
        c = aB
    end
)
RegisterNetEvent("XCEL:OpenStoreMenu")
AddEventHandler(
    "XCEL:OpenStoreMenu",
    function()
...
RegisterCommand(
    "store",
    function()
        TriggerServerEvent("XCEL:OpenStore")
    end
)
RegisterNetEvent(
    "XCEL:setStoreRankName",
    function(aC)
        i = aC
    end
)
