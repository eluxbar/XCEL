...
local b=false
RMenu.Add('crosshair','main',RageUI.CreateMenu("Crosshair","XCEL Crosshair Customisation ",tXCEL.getRageUIMenuWidth(),tXCEL.getRageUIMenuHeight()))
    ...
    if RageUI.Visible(RMenu:Get('crosshair', 'main')) then
        RageUI.DrawContent({ header = true, glare = true, instructionalButton = false}, function()
            ...
            if a.options.enabled == 1 then
                RageUI.Separator("Crosshair Options")
            end
            if a.options.enabled==1 then 
