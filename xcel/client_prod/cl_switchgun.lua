                            ...
                            if table.has(i, o) then
                                ...
                                if p ~= `WEAPON_UNARMED` and not table.has(i, p) then
                                    ...
                                    if o == "WEAPON_PDGLOCK" and GetPedDrawableVariation(n, 7) == 187 then
                                        tXCEL.loadCustomisationPreset("TaserInHolster")
                                    end
                                    if not d then
                                        a = false
                                        b = false
                            ...
                            if table.has(i, f) then
                                ...
                                if p ~= `WEAPON_UNARMED` and not table.has(i, p) then
                                    ...
                                    if h and GetPedDrawableVariation(n, 7) == 161 then
                                        tXCEL.loadCustomisationPreset("TaserOutHolster")
                                    end
                                end
                            else
                                loadAnimDict("reaction@intimidation@1h")
                                ...
                                RemoveAnimDict("reaction@intimidation@1h")
                                b = true
                                tXCEL.setWeapon(n, GetHashKey(f), true)
                                Citizen.Wait(1300)
                                tXCEL.setWeapon(n, "WEAPON_UNARMED", true)
                                Citizen.Wait(700)
                                ClearPedTasks(n)
                                a = true
                                b = false
...
function tXCEL.setWeapon(m, r, s)
