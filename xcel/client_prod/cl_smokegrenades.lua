...
local function b()
    ...
    TriggerServerEvent("XCEL:startThrowSmokeGrenade", c)
    Citizen.Wait(100)
    ...
    TriggerServerEvent("XCEL:endThrowSmokeGrenade", c, g)
end
local function h(i)
...
RegisterNetEvent(
    ...
    function(c, g)
        ...
        Citizen.Wait(60000)
        tXCEL.removeArea("smoke_" .. tostring(c))
        if l.handle then
            StopParticleFxLooped(l.handle, false)
            l.handle = nil
            l.isDeleted = true
