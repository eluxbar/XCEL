...
RMenu.Add(
    "XCELStores",
    "confirm",
    RageUI.CreateSubMenu(RMenu:Get("XCELStores", "main", tXCEL.getRageUIMenuWidth(), tXCEL.getRageUIMenuHeight()))
)
RageUI.CreateWhile(
    1.0,
    true,
    function()
        if RageUI.Visible(RMenu:Get("XCELStores", "main")) then
            RageUI.DrawContent(
...
RageUI.CreateWhile(
    ...
    true,
    function()
        if RageUI.Visible(RMenu:Get("XCELStores", "confirm")) then
            RageUI.DrawContent(
                {header = true, glare = false, instructionalButton = true},
                function()
                    RageUI.Separator(
            ...
            for b, c in pairs(a.shops) do
                ...
                if isInArea(c, 1.0) and j == false then
                    ...
                    if IsControlJustPressed(0, 51) then
                        ...
                        RageUI.Visible(RMenu:Get("XCELStores", "main"), true)
                        cLoaction = c
                    end
                end
