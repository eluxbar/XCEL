RegisterNetEvent("XCEL:announceRestart")
AddEventHandler(
    "XCEL:announceRestart",
    function(a, b)
...
RegisterNetEvent(
    "XCEL:smallAnnouncement",
    function(g, h, i, j)
        tXCEL.announceMpSmallMsg(g, h, i, j)
    end
)
function tXCEL.announceMpSmallMsg(g, h, i, j)
