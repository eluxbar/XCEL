            ...
            RageUI.DrawContent(
                ...
                function()
                    ...
                    RageUI.Button(
                        ...
                        function(g, h, i)
                            if i then
                                TriggerServerEvent("XCEL:selectLoadout", b)
...
RegisterNetEvent("XCEL:gotLoadouts")
AddEventHandler(
    "XCEL:gotLoadouts",
    function(j)
        a = j
        ...
        if l then
            ...
            local p = function(n)
                if IsControlJustPressed(1, 38) then
                    TriggerServerEvent("XCEL:getPoliceLoadouts")
                    RageUI.Visible(
                        RMenu:Get("policeloadouts", "main"),
            ...
            for e, f in pairs(d) do
                tXCEL.createArea("police_loadouts_" .. e, f, 1.5, 6, m, o, p, {locationId = e})
            end
        end
    end
)
