RMenu.Add(
    "XCELclothing",
    "mainMenu",
    RageUI.CreateMenu("", "Clothing Store", tXCEL.getRageUIMenuWidth(), tXCEL.getRageUIMenuHeight(), "banners", "cstore", "xcel_clothesui", "xcel_clothesui")
)
RMenu.Add("XCELclothing", "changePed", RageUI.CreateSubMenu(RMenu:Get("XCELclothing", "mainMenu"), "", "Change Gender"))
RMenu.Add(
    "XCELclothing",
    "changeClothing",
    RageUI.CreateSubMenu(RMenu:Get("XCELclothing", "mainMenu"), "", "Change your Clothes")
)
RMenu.Add("XCELclothing", "clearProps", RageUI.CreateSubMenu(RMenu:Get("XCELclothing", "mainMenu"), "", "Clear Props"))
local a = {
...
local r = {
    ...
    vector3(-449.1389465332,6016.548828125,31.716402053833),
    ...
    vector3(-2152.1813964844,5232.2026367188,18.780422210693),
...
Citizen.CreateThread(
    function()
        while true do
            local G = GetEntityCoords(tXCEL.getPlayerPed())
            for H = 1, #r do
                if #(G - r[H]) <= 2.5 and not t then
                    ...
                    h = true
                    RageUI.Visible(RMenu:Get("XCELclothing", "mainMenu"), true)
                elseif s == H then
                    ...
                    if not RageUI.Visible(RMenu:Get("XCELclothing", "changeClothing")) then
                        F()
                    end
                end
            end
...
RageUI.CreateWhile(
    ...
    function()
        if not n then
            if RageUI.Visible(RMenu:Get("XCELclothing", "mainMenu")) then
                RageUI.DrawContent(
                    ...
                    function()
                        RageUI.Button(
                            ...
                            RMenu:Get("XCELclothing", "changeClothing")
                        )
                        if not inOrganHeist then
                            RageUI.Button(
                                ...
                                RMenu:Get("XCELclothing", "changePed")
                            )
                        end
                        RageUI.Button(
                            "~y~Wardrobe",
                            ...
                            function(L, M, N)
                                if N then
                                    if tXCEL.isPlusClub() or tXCEL.isPlatClub() then
                                        TriggerEvent("XCEL:openOutfitMenu")
                                    else
                                        tXCEL.notify(
                        ...
                        if PlayerIsInGang then
                            RageUI.Button(
                                ...
                                function(L, M, N)
                                    if N then
                                        TriggerServerEvent("XCEL:applyGangFit", gangID)
                                    end
                                end
                            )
                        end
                        RageUI.Button(
                            "Apply Outfit Code",
                            "Applys an outfit code given by a player with ~y~XCEL Plus~w~ or ~y~XCEL Platinum~w~.",
                            {RightLabel = "→→→"},
                            true,
                            function(L, M, N)
                                if N then
                                    tXCEL.clientPrompt(
                                        ...
                                        function(O)
                                            ...
                                            if #P == 5 then
                                                TriggerServerEvent("XCEL:applyOutfitCode", string.upper(P))
                                            else
                        ...
                        RageUI.Button(
                            ...
                            RMenu:Get("XCELclothing", "clearProps")
                        )
                    end
                )
            end
            if RageUI.Visible(RMenu:Get("XCELclothing", "changePed")) then
                RageUI.DrawContent(
                    {header = true, glare = false, instructionalButton = false},
                    function()
                        RageUI.Button(
                            ...
                            function(L, M, N)
                                if N then
                                    if GetEntityHealth(PlayerPedId()) > 102 then
                                        tXCEL.loadCustomisationPreset("DefaultMale")
                                    else
                                        tXCEL.notify("Cannot change gender, you're dead.")
                                    end
                                end
                            end,
                            function()
                        ...
                        RageUI.Button(
                            ...
                            function(L, M, N)
                                if N then
                                    if GetEntityHealth(PlayerPedId()) > 102 then
                                        tXCEL.loadCustomisationPreset("DefaultFemale")
                                    else
                                        tXCEL.notify("Cannot change gender, you're dead.")
                                    end
                                end
            ...
            if RageUI.Visible(RMenu:Get("XCELclothing", "changeClothing")) then
                RageUI.DrawContent(
                    {header = true, glare = false, instructionalButton = false},
                    function()
                        m = true
                                    ...
                                    function(L, M, N, O)
                                        ...
                                        if N then
                                            ...
                                            if k.index == 2 then
                                                ...
                                                TriggerServerEvent(
                                                    "XCEL:saveClothingHairData",
                                                    GetPedDrawableVariation(tXCEL.getPlayerPed(), 2),
                                                    GetPedHairColor(tXCEL.getPlayerPed())
                                                )
            ...
            if RageUI.Visible(RMenu:Get("XCELclothing", "clearProps")) then
                RageUI.DrawContent(
                    {header = true, glare = false, instructionalButton = false},
                    function()
                        RageUI.Button(
                            ...
                            function(L, M, N)
                                if N then
                                    ClearPedProp(tXCEL.getPlayerPed(), 0)
                                end
                            end,
                            function()
                            end,
                        ...
                        RageUI.Button(
                            ...
                            function(L, M, N)
                                if N then
                                    ClearPedProp(tXCEL.getPlayerPed(), 1)
                                end
                            end,
                            function()
                            end,
                        ...
                        RageUI.Button(
                            ...
                            function(L, M, N)
                                if N then
                                    ClearPedProp(tXCEL.getPlayerPed(), 2)
                                end
                            end,
                            function()
                            end,
                        ...
                        RageUI.Button(
                            ...
                            function(L, M, N)
                                if N then
                                    ClearPedProp(tXCEL.getPlayerPed(), 6)
                                end
                            end,
                            function()
                            end,
                        ...
                        RageUI.Button(
                            ...
                            function(L, M, N)
                                if N then
                                    ClearPedProp(tXCEL.getPlayerPed(), 7)
                                end
                            end,
                            function()
                            end,
...
function current_clothing(P, i, R)
    if P == "prop" then
        if R then
            if GetPedPropTextureIndex(tXCEL.getPlayerPed(), i) ~= nil then
                return GetPedPropTextureIndex(tXCEL.getPlayerPed(), i)
            else
                return 0
            end
        else
            if GetPedPropIndex(tXCEL.getPlayerPed(), i) ~= nil then
                if GetPedPropIndex(tXCEL.getPlayerPed(), i) == -1 then
                    return GetPedPropIndex(tXCEL.getPlayerPed(), i) + 2
                else
                    return GetPedPropIndex(tXCEL.getPlayerPed(), i) + 1
                end
            else
                return 0
            end
    ...
    elseif P == "drawable" then
        ...
        elseif R then
            if GetPedTextureVariation(tXCEL.getPlayerPed(), i) ~= nil then
                return GetPedTextureVariation(tXCEL.getPlayerPed(), i)
            else
                return 0
            end
        else
            if GetPedDrawableVariation(tXCEL.getPlayerPed(), i) ~= nil then
                return GetPedDrawableVariation(tXCEL.getPlayerPed(), i) + 1
            else
                return 0
            end
        end
...
function get_textures(S, P, i)
    if S == "drawable" then
        ...
        j = GetNumberOfPedTextureVariations(tXCEL.getPlayerPed(), P, i - 1)
        return j
    else
        j = GetNumberOfPedPropTextureVariations(tXCEL.getPlayerPed(), P, i - 1)
        return j
    end
end
local function X()
...
Citizen.CreateThread(
    function()
        while true do
            if k.index ~= nil and RageUI.Visible(RMenu:Get("XCELclothing", "changeClothing")) then
...
local function _()
    local a0 = {
        {["label"] = "Enter Clothing ID ", ["button"] = "~INPUT_CELLPHONE_EXCEL_OPTION~"},
    ...
    function(D, E)
        if E then
            for a4, a5 in pairs(r) do
                tXCEL.addBlip(a5.x, a5.y, a5.z, 73, 3, "Clothing Store", 0.7)
                tXCEL.addMarker(
                    a5.x,
                    a5.y,
                    a5.z,
