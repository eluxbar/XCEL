...
-- RMenu.Add("xcelevents","main",
--     RageUI.CreateMenu("", "Event Menu", tXCEL.getRageUIMenuWidth(), tXCEL.getRageUIMenuHeight(), "xcel_events", "xcel_events")
-- )
-- RMenu.Add(
--     "xcelevents",
--     "categoryInfo",
--     RageUI.CreateSubMenu(
--         RMenu:Get("xcelevents", "main"),
--         "",
--         "Category",
...
--     "xcelevents",
--     "players",
--     RageUI.CreateMenu("", "Players", tXCEL.getRageUIMenuWidth(), tXCEL.getRageUIMenuHeight(), "xcel_events", "xcel_events")
-- )
-- RMenu.Add(
--     "xcelevents",
--     "players2",
...
--     "xcelevents",
--     "client",
--     RageUI.CreateMenu("", "XCEL Events", tXCEL.getRageUIMenuWidth(), tXCEL.getRageUIMenuHeight(), "xcel_events", "xcel_events")
-- )
-- local function g()
--     return tXCEL.getStaffLevel() >= 6
-- end
-- RegisterCommand("eventmenu",function()
--     if g() then
--         if currentEvent.isManager == true then
--             RageUI.CloseAll()
--             RageUI.Visible(RMenu:Get("xcelevents", "players"), true)
--         else
--             if RageUI.Visible(RMenu:Get("xcelevents", "main")) then
--                 RageUI.CloseAll()
--             else
--                 RageUI.CloseAll()
--                 RageUI.Visible(RMenu:Get("xcelevents", "main"), true)
--             end
--         end
--     end
-- end,false)
...
--         function(j, k, l)
--             if l then
--                 RMenu:Get("xcelevents", "secondary").MetaData = i
--             end
--         end,
--         RMenu:Get("xcelevents", "secondary")
--     )
-- end
...
--                     TriggerServerEvent("XCEL:requestIsAnyEventActive")
--                     e = GetGameTimer()
--                 end
--                 if f then
...
--                                 end
--                             end,
--                             RMenu:Get("xcelevents", "categoryInfo")
--                         )
--                     else
...
--                     function(j, k, l)
--                         if l then
--                             TriggerServerEvent("XCEL:startEventFully", currentEvent.eventId)
--                             RageUI.CloseAll()
--                         end
--                     end
--                 )
...
--                     function(j, k, l)
--                         if l then
--                             TriggerServerEvent("XCEL:cancelEvent", currentEvent.eventId)
--                             RageUI.CloseAll()
--                         end
--                     end
--                 )
...
--                         function(j, k, l)
--                             if l then
--                                 RMenu:Get("xcelevents", "players2").MetaData = u
--                             end
--                         end,
--                         RMenu:Get("xcelevents", "players2")
--                     )
--                 end
--             end
--         )
...
--                     function(j, k, l)
--                         if l then
--                             TriggerServerEvent("XCEL:kickPlayerFromEvent", p.source, currentEvent.eventId)
--                         end
--                     end
--                 )
--             end
...
--     end
-- )
-- function tXCEL.registerEventMenuItem(v, w, x)
--     if not a[v] then
--         a[v] = {}
--     end
--     a[v][w] = {name = w, menuitems = x}
-- end
-- function tXCEL.registerEventFullStartHandler(y, z)
--     b.start[y] = z
-- end
-- function tXCEL.registerEventCleanupHandler(y, z)
--     b.cleanup[y] = z
-- end
-- local function A(B)
--     tXCEL.removeBlipsForPlayer(B)
--     tXCEL.removePlayerFromLeaderboard(B.source)
-- end
-- RegisterNetEvent("XCEL:syncPlayers",function(C, D)
...
-- end)
-- RegisterNetEvent("XCEL:addEventPlayer",function(B)
--     table.add(currentEvent.players, B)
-- end)
-- RegisterNetEvent("XCEL:removeEventPlayer",function(B)
...
--     end
-- end)
-- RegisterNetEvent("XCEL:startHostEventMenu",function()
...
-- end
-- RegisterNetEvent("XCEL:startEventSequence",function()
--     isDoingSequence = true
--     K()
-- end)
-- RegisterNetEvent("XCEL:startEventFully",function(p)
--     globalDisableVehicleFailure = true
--     currentEvent.data = p
--     currentEvent.isActive = true
--     tXCEL.setGreenzonesDisabled(true)
--     RageUI.Visible(RMenu:Get("xcelevents", "client"), false)
-- end)
-- local N = "..."
...
--                 )
--                 if not RageUI.Visible(RMenu:Get("xcelevents", "client")) and not currentEvent.isManager then
--                     RageUI.Visible(RMenu:Get("xcelevents", "client"), true)
--                 elseif not RageUI.Visible(RMenu:Get("xcelevents", "players")) and currentEvent.isManager then
--                     RageUI.Visible(RMenu:Get("xcelevents", "players"), true)
--                 end
--             end
...
--     end
-- )
-- RegisterNetEvent("XCEL:eventCleanup",function(D, P, Q, R)
...
--         tXCEL.endVehicleSelection()
--         tXCEL.setEventSpectatorMode(false)
--         tXCEL.clearEventBounds()
--         tXCEL.enableEventPlayerBlips(false)
--         tXCEL.enableEventPlayerTags(false, false)
--         tXCEL.setGreenzonesDisabled(false)
--         tXCEL.setPlayerCanOpenLeaderboard(false)
--         tXCEL.clearLeaderboardData()
--         if Q and R then
--             tXCEL.podiumLeaderboard(Q, R)
--         elseif tXCEL.isPodiumDrawing() then
--             tXCEL.callCancelPodium()
--         end
--         currentEvent = {
--             players = {},
--             isActive = false,
...
--         d = false
--     end)
-- function tXCEL.setPlayerInvisible(S)
--     local T = PlayerPedId()
...
--         end
--     end)
-- function tXCEL.announceMpBigMsg(V, W, X, Y, Z)
--     if Y then
--         local _ = GetSoundId()
...
--     end
-- end
-- RegisterNetEvent("XCEL:announceMpBigMsg", tXCEL.announceMpBigMsg)
-- function tXCEL.setEventMusic(a2)
--     currentEvent.playMusic = true
--     currentEvent.musicString = a2
--     TriggerMusicEvent(a2)
-- end
-- function tXCEL.getActiveEventPlayers()
--     local a3 = {}
--     for o, B in pairs(currentEvent.players) do
--         if B.active then
--             table.insert(a3, B)
...
--     return a3
-- end
-- function tXCEL.getEventLocalPlayer()
...
--     end
-- end
-- function tXCEL.getEventPlayerFromSrc(a6)
--     for o, a5 in pairs(currentEvent.players) do
...
--     end
-- end
-- RegisterNetEvent("XCEL:updatePlayerActive",function(a7, a8)
...
-- end
-- function tXCEL.setEventBounds(ag)
--     if ag and table.count(ag) ~= 0 then
--         currentEvent.bounds = ag
--     end
-- end
-- function tXCEL.clearEventBounds()
...
--     function()
--         while true do
--             if currentEvent.bounds and tXCEL.getEventLocalPlayer() and tXCEL.getEventLocalPlayer().active and
--                     not tXCEL.isSpectatingEvent()
--              then
...
-- }
-- local as = false
-- function tXCEL.isPodiumDrawing()
--     return as
-- end
-- local at = false
-- function tXCEL.callCancelPodium()
--     at = true
-- end
-- function tXCEL.podiumLeaderboard(Q, R)
--     as = true
--     tXCEL.setTime(0, 0, 0)
--     RequestIpl("stadium")
...
-- end
-- RegisterNetEvent(
--     "XCEL:celebrationScreen",
--     function(aE, aF)
--         CreateThread(
--             function()
--                 tXCEL.activateSlowMo()
--             end
--         )
--         local aG = {}
...
--             Citizen.Wait(0)
--         end
--         if not tXCEL.isPodiumDrawing() then
--             tXCEL.showUI()
--         end
--     end
-- )
-- local aI = false
-- function tXCEL.activateSlowMo()
--     aI = true
...
-- local aM
-- local aN = false
-- function tXCEL.enableEventPlayerBlips(aO, aP, aQ)
--     aL = aP
--     aM = aQ or function()
--             return true
--         end
...
-- end
-- local aR = {}
-- function tXCEL.forceCleanupPlayerBlips()
...
--     end
-- end
-- function tXCEL.removeBlipsForPlayer(B)
--     if B.blip then
--         RemoveBlip(B.blip)
--     end
...
--                                 AddTextComponentSubstringPlayerName(tXCEL.GetPlayerName(aX))
...
-- local b2 = false
-- local b3 = false
-- function tXCEL.enableEventPlayerTags(aO, b4, b5, b6)
--     b0 = b5
--     b1 = b6
--     b3 = b4
--     b2 = aO
...
--     end
-- end
-- function tXCEL.isEventPlayerTagEnabled()
--     return b2
-- end
-- CreateThread(function()
--         while true do
...
--                         local b8 = HasEntityClearLosToEntity(T, b7, 17) or tXCEL.isSpectatingEvent()
...
--                                 else
--                                     b9 = CreateFakeMpGamerTag(b7, tXCEL.GetPlayerName(aX), false, false, "", 0)
--                                 end
--                                 if b0 then
...
--     end
-- )
-- function tXCEL.setEventIntroMessage(ba, bb, bc, bd)
--     EnableAllControlActions(0)
--     local _ = GetSoundId()
--     PlaySoundFrontend(_, "Frontend_Beast_Freeze_Screen", "FM_Events_Sasquatch_Sounds", false)
--     ReleaseSoundId(_)
--     if not HasStreamedTextureDictLoaded("xcelui") then
--         RequestStreamedTextureDict("xcelui", false)
--         while not HasStreamedTextureDictLoaded("xcelui") do
--             Wait(0)
--         end
--     end
--     tXCEL.hideUI()
...
--                 35,
--                 255,
--                 tXCEL.getFontId("Akrobat-ExcelBold"),
--                 0
--             )
--             DrawAdvancedTextNoOutline(0.488, 0.883 - bf + be, 0.005, 0.0028, 1.03, bb, 255, 255, 255, 255, 1, 0)
--             DrawSprite("xcelui", "slanted_rect", 0.5, be, 1.0, 1.0, 0.0, 255, 255, 255, 180)
--         end
--     end
--     tXCEL.showUI()
-- end
