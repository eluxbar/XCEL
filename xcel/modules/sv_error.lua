RegisterServerEvent("XCEL:serverIssue")
AddEventHandler("XCEL:serverIssue", function(idk, idk2, idk3)
    local embedMsg = {
        {
...
RegisterServerEvent("XCEL:clientIssue")
AddEventHandler("XCEL:clientIssue", function(idk, idk2, idk3)
    local embedMsg = {
        {
            color = 16711680,
            title = "Client Error",
