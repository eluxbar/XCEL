local webhooks = {
    -- general
    ['join'] = 'https://discord.com/api/webhooks/1274522584825991188/0L81410Iag-0wWtxJ6lx3CsHHaNz5ldjj0Cn-HX446fjlOLziW7M7W7k4X7q8hL4gIOT',
        ...
        if next(webhookQueue) then
            for k,v in pairs(webhookQueue) do
                ...
                if webhooks[v.webhook] ~= nil then
                    ...
                    end, "POST", json.encode({username = "XCEL Logs", avatar_url = 'https://imgur.com/a/D2w4Ki7', embeds = {
                        {
                            ["color"] = 0x57F288,
                            ["title"] = v.name,
