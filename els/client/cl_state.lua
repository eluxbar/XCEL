...
RegisterNetEvent("XCELELS:changeStage", function(netId, stage)
...
RegisterNetEvent("XCELELS:toggleSiren", function(netId, tone)
	if not VehicleConfigs then return end
...
RegisterNetEvent("XCELELS:toggleBullhorn", function(netId, enabled)
	if not VehicleConfigs then return end
...
RegisterNetEvent("XCELELS:patternChange", function(netId, patternIndex, enabled)
	if not VehicleConfigs then return end
...
RegisterNetEvent("XCELELS:vehicleRemoved", function(netId)
...
RegisterNetEvent("XCELELS:indicatorChange", function(netId, indicator, enabled)
