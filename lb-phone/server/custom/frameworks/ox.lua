...
CreateThread(function()
    ...
    function AddMoney(source, amount)
        if GetResourceState("pefcl") == "started" then
            return exports.pefcl:addBankBalance(source, { amount = amount, message = "XCEL Phone" })
        end
    ...
    function RemoveMoney(source, amount)
        if GetResourceState("pefcl") == "started" then
            return exports.pefcl:removeBankBalance(source, { amount = amount, message = "XCEL Phone" })
        end
