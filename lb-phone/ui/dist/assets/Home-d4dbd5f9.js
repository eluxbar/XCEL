...
function K() {
    const [P, t] = n.useState([]), o = H(_.Unlocked), [c, l] = n.useState(null), [m, E] = n.useState(1);
    return n.useEffect(() => {
        ...
        r("Home", {
            ...
            if (!s) return f("warning", "Didn't receive any response from getHomes callback");
            t(s)
        })
    }, []), a("div", {
...
const b = ({
    ...
    const [t, o] = n.useState(P), c = n.useRef(null);
    return a(O, {
        children: [a("div", {
            className: "title",
            ...
            children: t == null ? void 0 : t.keyholders.map((l, m) => a("div", {
                        ...
                        buttons: [{
                            ...
                            cb: () => {
                                r("Home", {
                                    ...
                                    E && o({
                                        ...t,
                                        keyholders: t.keyholders.filter(s => s !== l)
                                    })
                                })
                            }
                        }]
